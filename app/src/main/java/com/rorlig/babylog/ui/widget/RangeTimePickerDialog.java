...
/**
 * @author gaurav gupta
 * http://stackoverflow.com/questions/13516389/android-timepickerdialog-set-max-time
 */
public class RangeTimePickerDialog extends TimePickerDialog {
    ...
    private String TAG = "RangeTimePicker";
    ...
    public void updateDialogTitle(TimePicker timePicker, int hourOfDay, int minute) {
