 ...
 */
public class BottleFeedingActivity extends InjectableActivity {
...
//        ((TextView)v.findViewById(R.id.actionBarTitle)).setText("greet");
        ...
        Typeface typeface = typeFaceManager.getTypeFace(getString(R.string.font_bree_light));
...
////        drawerLayout.setDrawerLockMode(1);
        ...
        showFragment(BottleFeedFragment.class, "bottle_fragment", false);
//        } else {
//
//        }
