...
//
    ...
    public SleepDao(String merchantName, int cardValue, long cardBuyTime, boolean isSend, String contactName, String imageURL) {
    ...
    public static final Creator<SleepDao> CREATOR = new Creator<SleepDao>() {
        public SleepDao createFromParcel(Parcel source) {
            return new SleepDao(source);
        }

        public SleepDao[] newArray(int size) {
            return new SleepDao[size];
        }
    };
}
