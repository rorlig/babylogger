 ...
 */
@DatabaseTable
public class GrowthDao implements Parcelable {
...
//
    ...
    public GrowthDao(String merchantName, int cardValue, long cardBuyTime, boolean isSend, String contactName, String imageURL) {
    ...
    public static final Creator<GrowthDao> CREATOR = new Creator<GrowthDao>() {
        public GrowthDao createFromParcel(Parcel source) {
            return new GrowthDao(source);
        }

        public GrowthDao[] newArray(int size) {
            return new GrowthDao[size];
        }
    };
}
